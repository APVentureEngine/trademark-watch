...
def onepager(free=False):
    ...
    steps = [
        ...
        "   apventureengine.github.io/trademark-watch/alerts/ , type your mark and the email address you",
        "   used at checkout, and it opens your page. Bookmark it, or subscribe to its RSS feed (link at the",
        "   top of the page) if you would rather be pushed than pull. Optional: if you gave a GitHub username",
        "   at checkout you also get invited to a private repo with the same alerts as files.",
